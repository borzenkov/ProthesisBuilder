...
////}
//
//void ProthesisBuilder::CreateAdheringSurface(Direction_3 &direction, Polyhedron &mesh, Polyhedron &rezult)
//{
...
//	{
//		if (fi->plane().orthogonal_direction() == direction)
//		{
//			fc = fi->facet_begin();
//			do
//			{
...
//		}
//		else if (fi->plane().orthogonal_direction() != -direction)
//		{
//			if (fi->plane().orthogonal_direction().vector() * direction.vector() == 0)
//			{
//				fc = fi->facet_begin();
//				do
//				{
...
//				do
//				{
//					coordsOfThirdGroup.push_back(fc->vertex()->point().x());
//					coordsOfThirdGroup.push_back(fc->vertex()->point().y());
//					coordsOfThirdGroup.push_back(fc->vertex()->point().z());
//					trisOfThirdGroup.push_back(++indexOfPointInThirdGroup);
//				}
//				while (++fc != fi->facet_begin());
//			}
//		}
//	}
//	//Form triangles into groups
//	//Select projecting triangles
//	//Project them
//}